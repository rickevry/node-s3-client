...
function Client(options) {
  ...
  this.multipartUploadDisabled = options.multipartUploadDisabled || false;
...
Client.prototype.uploadFile = function(params) {
  ...
  if (self.multipartUploadDisabled) {
    openFileSimpleFileStream();
  } else {
    openFile();
  }
  ...
  function openFileSimpleFileStream() {
